...
import pytest
import numpy
from dolfin import (RectangleMesh, MPI, CellType, FunctionSpace, Constant,
...
def test_lhs_rhs_simple():
    ...
    mesh = RectangleMesh.create(MPI.comm_world, [numpy.array((0, 0)), numpy.array((2, 1))], [3, 5], CellType.Type.triangle)
